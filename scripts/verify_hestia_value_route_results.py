...
def validate_manifest(value):
    ...
    pattern = re.compile(
        r"(?:(?:registration|permit|cpu-check|doctor-check|normalization-check|worker-exited)\.json|condition-(?:base1280|base640|base1280_vfull640|base640_vfull1280|base1280_vimage640|base640_vimage1280|base1280_vlanguage640|base640_vlanguage1280|base1280_vstate640|base640_vstate1280)\.log|(?:base1280|base640|base1280_vfull640|base640_vfull1280|base1280_vimage640|base640_vimage1280|base1280_vlanguage640|base640_vlanguage1280|base1280_vstate640|base640_vstate1280)/(?:intervention\.json|calibration\.json|calibration\.npz|arrays\.npz|result\.json|failure\.json|first-control\.json|first-control-failure\.npz))"
    )
    total = 0

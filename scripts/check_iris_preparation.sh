...
if [[ "${1:-check}" == prepare ]]; then
 mkdir -p runs/iris-furnace-preparation-20260913-001
 mounts+=(--mount "type=bind,source=$repo/runs/iris-furnace-preparation-20260913-001,target=/workspace/runs/iris-furnace-preparation-20260913-001")
fi
...
if [[ "$MODE" == prepare ]]; then
 python scripts/run_iris_furnace.py prepare --template runs/iris-furnace-preparation-20260913-001/template.json
 exit
fi

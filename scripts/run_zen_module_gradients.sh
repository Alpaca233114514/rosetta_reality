...
readonly STATUS_PATH="${ORCHESTRATION_ROOT}/zen-module-gradients-004.status"
readonly LOG_PATH="${ORCHESTRATION_ROOT}/zen-module-gradients-004.log"
...
set +e
{
    ...
    ROSETTA_CONTAINER_NAME=zen-module-gradients-004 \

...
from scripts.analyze_hestia_image_value_component import IMAGE, OUTPUT, ROOT
from scripts.diagnose_hestia_checkpoint_localization import file_hash, read_json, require
from scripts.hestia_image_value_component import CONDITIONS
...
def main():
    ...
    plan = read_json(
        "reports/training/m2-smolvla-hestia-image-value-component-events-plan-2026-09-12.json"
    )
    ...
    arrays = {}
    for name in (*CONDITIONS, "base1280_vimage640", "base640_vimage1280"):

"""Guarded eighteen-condition single-layer V intervention; requires explicit authorization."""
...
def supervise(args, template):
    ...
    registration = {
        ...
        "shutdown_deadline_unix": started + 2100,
        ...
        "allowed_conditions": [
            ...
            "base1280_vimage640",
            "base640_vimage1280",
            "base1280_vlanguage640",
            "base640_vlanguage1280",
            "base1280_vstate640",
            "base640_vstate1280",
        ],
    ...
    try:
        ...
        check = subprocess.run(
            [
                ...
                "tests/test_hestia_value_route.py",
                "tests/test_hestia_value_route_cli.py",
        ...
        for condition in registration["allowed_conditions"]:
            ...
            with (job / f"condition-{condition}.log").open("xb") as stream:
                child = subprocess.Popen(
                    [
                        sys.executable,
                        "scripts/diagnose_hestia_value_route.py",
                        "--template",
                        str(args.template),
                        "--permit",
                        str(job / "permit.json"),

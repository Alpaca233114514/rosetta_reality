...
def validate_manifest(value):
    ...
    pattern = re.compile(
        r"(?:(?:registration|permit|cpu-check|doctor-check|normalization-check|worker-exited)\.json|condition-(?:base1280|base640|base1280_vfull640|base640_vfull1280|base1280_vglobal640|base640_vglobal1280|base1280_vtoken640|base640_vtoken1280|base1280_vscene640|base640_vscene1280)\.log|(?:base1280|base640|base1280_vfull640|base640_vfull1280|base1280_vglobal640|base640_vglobal1280|base1280_vtoken640|base640_vtoken1280|base1280_vscene640|base640_vscene1280)/(?:intervention\.json|calibration\.json|calibration\.npz|arrays\.npz|result\.json|failure\.json|first-control\.json|first-control-failure\.npz))"
    )
    total = 0

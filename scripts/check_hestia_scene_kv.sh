...
files=(scripts/analyze_hestia_scene_kv.py scripts/hestia_scene_kv.py scripts/diagnose_hestia_scene_kv.py scripts/run_hestia_scene_kv.py scripts/stream_hestia_scene_kv_results.py scripts/verify_hestia_scene_kv_results.py tests/test_hestia_scene_kv.py tests/test_hestia_scene_kv_cli.py)
mounts=()
if [[ "$mode" == format ]]; then

...
from scripts.analyze_hestia_value_route import IMAGE, OUTPUT, ROOT
from scripts.diagnose_hestia_checkpoint_localization import file_hash, read_json, require
from scripts.hestia_value_route import CONDITIONS
...
def main():
    ...
    plan = read_json("reports/training/m2-smolvla-hestia-value-route-events-plan-2026-09-12.json")

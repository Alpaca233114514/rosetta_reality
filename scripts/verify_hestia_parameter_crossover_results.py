...
def validate_manifest(value):
    ...
    pattern = re.compile(
        r"(?:(?:registration|permit|cpu-check|doctor-check|normalization-check|worker-exited)\.json|condition-(?:base1280|base640|base1280_kv640|base640_kv1280)\.log|(?:base1280|base640|base1280_kv640|base640_kv1280)/(?:intervention\.json|arrays\.npz|result\.json|failure\.json|first-control\.json|first-control-failure\.npz))"
    )
    total = 0

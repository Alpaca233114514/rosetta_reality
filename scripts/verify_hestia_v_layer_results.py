...
def validate_manifest(value):
    ...
    pattern = re.compile(
        r"(?:(?:registration|permit|cpu-check|doctor-check|normalization-check|worker-exited)\.json|condition-(?:base1280|base640|base1280_v1_640|base640_v1_1280|base1280_v3_640|base640_v3_1280|base1280_v5_640|base640_v5_1280|base1280_v7_640|base640_v7_1280|base1280_v9_640|base640_v9_1280|base1280_v11_640|base640_v11_1280|base1280_v13_640|base640_v13_1280|base1280_v15_640|base640_v15_1280)\.log|(?:base1280|base640|base1280_v1_640|base640_v1_1280|base1280_v3_640|base640_v3_1280|base1280_v5_640|base640_v5_1280|base1280_v7_640|base640_v7_1280|base1280_v9_640|base640_v9_1280|base1280_v11_640|base640_v11_1280|base1280_v13_640|base640_v13_1280|base1280_v15_640|base640_v15_1280)/(?:intervention\.json|arrays\.npz|result\.json|failure\.json|first-control\.json|first-control-failure\.npz))"
    )
    total = 0
        ...
        json.dumps(
            {
                ...
                "completed_conditions": worker.get("completed_conditions"),
            }
        ),
        flush=True,
    )

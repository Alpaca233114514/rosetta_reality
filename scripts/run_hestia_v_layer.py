...
def supervise(args, template):
    ...
    registration = {
        ...
        "deadline_unix": started + 2700,
        "shutdown_deadline_unix": started + 3000,
    ...
    try:
        ...
        check = subprocess.run(
            [
                ...
                "tests/test_hestia_v_layer.py",
                "tests/test_hestia_v_layer_cli.py",
        ...
        for condition in registration["allowed_conditions"]:
            ...
            with (job / f"condition-{condition}.log").open("xb") as stream:
                child = subprocess.Popen(
                    [
                        sys.executable,
                        "scripts/diagnose_hestia_v_layer.py",
                        "--template",
                        str(args.template),
                        "--permit",
                        str(job / "permit.json"),

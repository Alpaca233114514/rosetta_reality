...
readonly STATUS_PATH="${ORCHESTRATION_ROOT}/aster-trajectory-trace-002.status"
readonly LOG_PATH="${ORCHESTRATION_ROOT}/aster-trajectory-trace-002.log"
...
ROSETTA_CONTAINER_NAME=aster-trajectory-trace-002 \
    scripts/run_m2_container.sh vla-sim-xpu \
    python -u scripts/diagnose_smolvla_aster_trajectory.py \
    --plan /workspace/configs/vla/smolvla_450m_aloha_insertion_aster_trace_sim_007.yaml \
    --episode 2 \
    --seed 10 \

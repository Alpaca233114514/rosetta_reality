...
from scripts import diagnose_hestia_parameter_crossover_v2 as fixed
from scripts.hestia_parameter_crossover import CONDITIONS, condition_spec
...
def fixture(tmp_path, monkeypatch, module, condition="base1280", *, fake_gpu=True):
    ...
    plan = {
        "id": "hestia-parameter-crossover-20260912-" + ("001" if module is old else "002"),
        "output": "job",
...
def test_old_cli_reproduces_observed_path_type_failure(tmp_path, monkeypatch):
    calls, _ = fixture(tmp_path, monkeypatch, old)

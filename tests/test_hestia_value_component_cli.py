...
from scripts import diagnose_hestia_value_component as fixed
from scripts.hestia_value_component import CONDITIONS, component_mode, condition_spec
...
def fixture(tmp_path, monkeypatch, module, condition="base1280", *, fake_gpu=True):
    ...
    plan = {
        ...
        if module is old
        else "hestia-value-component-20260912-001",
        "output": "job",

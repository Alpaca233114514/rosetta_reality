...
def evidence(arm="C"):
    ...
    metadata = {
        ...
        "arm": arm,
        "episodes": visual_fit.TRAIN40 + visual_fit.DEV5,
        "views": {
            "train8": visual_fit.TRAIN40[:8],
            "train40": visual_fit.TRAIN40[:],
            "dev5": visual_fit.DEV5[:],
        },
        "hidden_episodes": visual_fit.HIDDEN5[:],

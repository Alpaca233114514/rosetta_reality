...
from scripts import diagnose_hestia_value_route as fixed
from scripts.hestia_value_route import CONDITIONS, component_mode, condition_spec
...
def fixture(tmp_path, monkeypatch, module, condition="base1280", *, fake_gpu=True):
    ...
    plan = {
        ...
        if module is old
        else "hestia-value-route-20260912-001",
        "output": "job",
...
def test_full_donor_positive_control_failure_blocks_components(tmp_path, monkeypatch):
    calls, _ = fixture(tmp_path, monkeypatch, fixed, "base1280_vimage640")
